...
//    }
    ...
    override func viewDidLoad() {
        ...
        genreCollectionView.register(UINib.init(nibName: "SegmentMovieCollectionViewCell", bundle: nil), forCellWithReuseIdentifier: "SegmentMovieCollectionViewCell")
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "MoviesSegue" {
            ...
            controller.movie = selectedMovieText
        }
...
extension HomeViewController:UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewFlowLayout{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if collectionView == self.collectionView {
            ...
            let movie = movies[indexPath.row] // mengambil data film dari keranjang movies (API)
            cell.setUpCell(movie: movie) // menghubungkan ke cell PopularMovieCollectionViewCell
            return cell
        }
        
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "SegmentMovieCollectionViewCell", for: indexPath) as! SegmentMovieCollectionViewCell
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewFlowLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        if collectionView == self.collectionView {
            let size = cellSize(widthInXr: 117, heightInXr: 205, cellSpacing: 0, leftInset: 16, rightInset: 16, numberOfCellInOneCollumn: 0, collectionView: collectionView)
            return size
        }
...
extension HomeViewController:SegmentMovieCollectionViewCellDelegate{
    func tapGenre() {
